# Практика по вёрстке макетов для сайтов 
...
## Ресурсы
Дока - документация для разработчиков на понятном языке. Её пишет сообщество, чтобы помогать друг другу. Ваши знания и опыт важны. Делитесь ими, мы поможем. [Дока](https://doka.guide/).
